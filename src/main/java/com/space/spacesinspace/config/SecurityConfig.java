...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(auth -> {
            auth.requestMatchers("/auth/login", "/auth/admin/login","/user/member/signup", "/auth/fail", "/fragments/*", "/user/product/productAll", "/user/product/productDetail", "/img/*", "/user/faq/list","/main", "/").permitAll();
